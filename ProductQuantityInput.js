  ...
  static appendButtons() {
    $( 'div.quantity:not(.field.has-addons)' ).each(function (i, el) {
      ...
      $container.addClass( 'field has-addons' )
        .append( '<span class="control"><button type="button" class="plus button is-light">+</button></span>' )
        .prepend( '<span class="control"><button type="button" class="minus button is-light">-</button></span>' );
    })
